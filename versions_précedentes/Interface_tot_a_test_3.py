...
# === Calcul d'aire de cycle filtrer B(H) (interpolation) ===
    ...
    def clear_canva(self):
        ...
        self.label_Bmax_value_filtre.setText(str(0))
        self.label_Hmax_value_filtre.setText(str(0))
        self.label_Br_value_filtre.setText(str(0))
        self.label_Hc_value_filtre.setText(str(0))
        self.label_Area_value_filtre.setText(str(0))
        self.label_Pv_value_filtre.setText(str(0))
        self.label_Bmax_value_filtre.setText(str(0))
        self.label_Hmax_value_filtre.setText(str(0))
        self.label_Br_value_filtre.setText(str(0))
        self.label_Hc_value_filtre.setText(str(0))
